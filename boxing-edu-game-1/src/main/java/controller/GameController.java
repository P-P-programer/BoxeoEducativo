            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (gameView.isBoxerAttackingJ()) {
                    ...
                    if (gameView.getBoxerAttackFrame() == 4) {
                        Rectangle boxerRect = new Rectangle(boxer.getX(), boxer.getY(), spriteSize, spriteSize);
                        Rectangle enemyRect = new Rectangle(enemy.getX(), enemy.getY(), spriteSize, spriteSize);
